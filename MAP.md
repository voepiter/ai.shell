...
| File | Lines | Role |
|------|-------|------|
| `ai.py` | 45 | Entry point — parses args, routes to setup / single-turn / chat |
...
| File | Lines | Key symbols |
|------|-------|-------------|
| `ui.py` | 119 | `print_banner`, `print_chat_help`, `print_stats`, `print_chat_totals`, `print_models`, `print_providers`, `print_current_status`, `fmt_num` |
