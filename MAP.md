...
telegram.py  290  Telegram bot integration — polling loop and LLM dispatch.
	...
	_notify(token, chat_id, key)  Send localized connect/disconnect notification with program name, version, and instance id.
